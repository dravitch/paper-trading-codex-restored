...
| Gate | Objet | État |
|---|---|---|
| P0 | baselines immuables | préparation; immuabilité distante non prouvée |
...
Aucun gate et aucune hypothèse métier ne sont validés. Le code de fusion n'est pas commencé. La baseline du dépôt restauré a été reproduite, mais celle du dépôt Bitget reste une preuve séparée ouverte. Les cycles achevés ont consolidé la spécification et son protocole probatoire; ils ne constituent ni une validation scientifique du moteur futur, ni une preuve de fidélité au marché.
...
2. terminer P0 avec des baselines et une preuve d'immuabilité vérifiables;
