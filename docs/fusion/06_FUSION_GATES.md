...
|---|---|---|---|
| P0 Baselines | hashes, versions, limites des deux dépôts | aucune affirmation sans source | retirer une source/hash |
| P1 Domaine | événements, instruments, ledgers spot/short | oracles comptables exacts | doubler frais ou levier |
| P2 Replay | scheduler et journal canonique | bundle backtest = replay | permuter ordre TP/SL |
| P3 Stratégies | Grid/RSI/MA sans I/O | intentions sur tables connues | changer seuil/signe |
...
| P6 RiskMap | domaine, Pareto, stabilité | O1–O7 et paysages passent | supprimer un FAIL |
| P7 Publication | CI, wheel, docs, licence | Python 3.10–3.12 verts | drift STATUS/docs |
