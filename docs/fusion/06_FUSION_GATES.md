...
| P1 Domaine | événements, instruments, ledgers spot/short | oracles comptables exacts; horloge injectée dans les nouveaux modules canoniques | doubler frais/levier; appeler `datetime.now()` dans `paper_trading_codex/domain/` ou `paper_trading_codex/replay/` |
