...
| Objet revu | Commit d'admission | Rapport | SHA-256 admis | Décision |
|---|---|---|---|---|
...
Toute réécriture d'historique invalide les admissions jusqu'à nouvelle décision opérateur. La publication finale exige une branche protégée ou une archive signée des commits d'admission.
