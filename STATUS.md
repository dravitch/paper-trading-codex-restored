...
<!-- TEST_STATUS_START -->
- Tests collectés : **68** dans **7** fichiers.
- Commande canonique : `python -m pytest tests -q`.
- Fichiers : `test_contracts.py`, `test_critical_5_5.py`, `test_data_fetcher.py`, `test_data_loader.py`, `test_grid_bot.py`, `test_performance_metrics.py`, `test_trade_auditor.py`.
<!-- TEST_STATUS_END -->
